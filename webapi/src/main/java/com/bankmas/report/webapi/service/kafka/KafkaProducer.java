...
public class KafkaProducer {
    ...
    public void sendUploadFile(String documentFileType, String id, String fileName) {
        MessageKafkaUploadFile message = MessageKafkaUploadFile.builder().id(id).fileName(fileName).build();
