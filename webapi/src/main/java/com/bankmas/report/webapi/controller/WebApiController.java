...
public class WebApiController {
    ...
    @PostMapping()
    public FileUploadCreateUpdateResponse createFileUpload(@Valid @RequestBody FileUploadRequest request){
        return fileUploadService.createFileUpload(request);
    }
    ...
    public String handleFileUploadProcess(
        ...
        try {
            return fileUploadService.uploadFile(topicEnum, file);   
        } catch (Exception e) {
